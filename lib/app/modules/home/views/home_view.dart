        ...
        child: Column(
          children: [
            ...
            Center(
              child: Container(
                width: double
                    .infinity, // Membuat header memanjang hingga batas layar
                height: 60, // Tinggi header diperbesar untuk menampung elemen
                padding: EdgeInsets.symmetric(
                    horizontal: 20), // Padding kiri dan kanan untuk jarak
                child: Stack(
                  children: [
                    Positioned(
                      left: 0,
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  ProfilePage(), // Navigasi ke halaman ProfilePage
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
                          ...
                          padding: EdgeInsets
                              .zero, // Hilangkan padding di dalam tombol
                          minimumSize: Size(40, 40), // Ukuran tombol
                        ),
                        child: Container(
                          width: 40,
                          height: 40,
                          decoration: ShapeDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                "assets/images/profile picture.png", // Gambar profil
                              ),
                              fit: BoxFit.cover,
                            ),
                            shape: OvalBorder(),
            ...
            Align(
              alignment:
                  Alignment.centerLeft, // Agar teks berada di paling kiri
              child: Padding(
                padding: const EdgeInsets.only(
                    left:
                        25.0), // Menyesuaikan padding kiri agar sejajar dengan gambar profil
                child: Text.rich(
                  TextSpan(
                    children: [
                      TextSpan(
            ...
            SizedBox(
                height:
                    48), // Jarak antara kontainer sebelumnya dan kontainer baru
            // Kontainer baru yang diminta
            Padding(
              padding: const EdgeInsets.symmetric(
                  horizontal: 20), // Padding yang sama dengan header
              child: Container(
                width: 400,
                height: 145,
                child: Stack(
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(
                                  ...
                                  color: Color(
                                      0xFFFFAD47), // Warna untuk ikon kedua
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(
                                  'assets/images/ph_pencil-line.png', // Ganti dengan gambar yang diinginkan
                                  color: Color(
                                      0xFFFFFFFF), // Warna untuk ikon pertama
                                  fit: BoxFit.contain,
                                ),
                              ),
                            ),
